...
const floatingIcons: IconData[] = [
  // Positioned symmetrically to clear the central content area
  { id: 1, icon: IconGoogle, className: "top-[12%] left-[6%] md:left-[10%]" },
  { id: 2, icon: IconApple, className: "top-[22%] right-[5%] md:right-[8%]" },
  { id: 3, icon: IconMicrosoft, className: "bottom-[22%] left-[6%] md:left-[10%]" },
  { id: 4, icon: IconFigma, className: "bottom-[12%] right-[6%] md:right-[10%]" },
  { id: 5, icon: IconGitHub, className: "top-[6%] left-[25%] md:left-[30%] hidden sm:block" },
  { id: 6, icon: IconSlack, className: "top-[6%] right-[25%] md:right-[30%] hidden sm:block" },
  { id: 7, icon: IconVercel, className: "bottom-[8%] left-[22%] md:left-[25%] hidden sm:block" },
  { id: 8, icon: IconStripe, className: "top-[42%] left-[4%] md:left-[8%] hidden md:block" },
  { id: 9, icon: IconDiscord, className: "bottom-[24%] right-[20%] md:right-[25%] hidden sm:block" },
  { id: 10, icon: IconX, className: "bottom-[8%] right-[28%] md:right-[32%] hidden sm:block" },
  { id: 11, icon: IconNotion, className: "top-[52%] right-[4%] md:right-[8%] hidden md:block" },
  { id: 12, icon: IconSpotify, className: "top-[58%] left-[2%] md:left-[5%] hidden lg:block" },
  { id: 13, icon: IconDropbox, className: "top-[6%] left-[45%] md:left-[52%] hidden lg:block" },
  { id: 14, icon: IconTwitch, className: "bottom-[6%] right-[42%] md:right-[48%] hidden lg:block" },
  { id: 15, icon: IconLinear, className: "top-[27%] right-[16%] md:right-[20%] hidden md:block" },
  { id: 16, icon: IconYouTube, className: "top-[62%] left-[20%] md:left-[24%] hidden md:block" },
];
...
const Icon = ({
  ...
  return (
    <motion.div
      ...
      className={cn("absolute select-none pointer-events-none sm:pointer-events-auto", iconData.className)}
    >
      <motion.div
        className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 p-1.5 sm:p-2 rounded-xl sm:rounded-2xl shadow-2xl bg-white/[0.03] backdrop-blur-md border border-white/10"
        animate={
          shouldReduceMotion
            ? {}
            : {
      ...
      >
        <iconData.icon className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-white" />
      </motion.div>
    </motion.div>
  );
};
...
export function HeroSection() {
  ...
  return (
    <section
      ...
      className="relative w-full min-h-screen py-32 flex items-center justify-center overflow-hidden bg-ink-950 text-white"
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 15% 20%, rgba(34,197,94,0.18), transparent 45%), radial-gradient(circle at 85% 0%, rgba(34,197,94,0.12), transparent 40%)",
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
        ...
        >
          <StatusDot live label="Live on 214 lead channels right now" />
        </motion.div>

        {/* Main Heading - Shortened & professionalized */}
        <motion.h1
          initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.1 }}
          className="mt-8 font-display text-3xl sm:text-4xl md:text-5xl font-bold leading-[1.15] tracking-tight max-w-2xl text-balance"
        >
          Your AI SDR replies to leads in under 10 seconds
        </motion.h1>
        ...
        <motion.p
          ...
          className="mt-6 max-w-xl text-sm sm:text-base text-white/60 leading-relaxed text-balance"
        >
          LeadPilot answers instantly, asks qualifying questions, and books qualified leads automatically—saving time and converting leads before they go cold.
        </motion.p>
        ...
        >
          ...
          <Button size="lg" variant="ghost-inverse" asChild className="border border-white/15">

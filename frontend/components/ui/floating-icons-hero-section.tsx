...
const Icon = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 p-1.5 sm:p-2 rounded-xl sm:rounded-2xl shadow-lg bg-card/80 backdrop-blur-md border border-border/10"
        animate={{
          y: [0, -6, 0, 6, 0],
          x: [0, 4, 0, -4, 0],
          rotate: [0, 3, 0, -3, 0],
      ...
      >
        <iconData.icon className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-foreground" />
      </motion.div>
    </motion.div>
  );
};
